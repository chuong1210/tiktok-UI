...
export const HomeActiveIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            className={classNames}
            width={width}
...
export const HomeIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            className={classNames}
            width={width}
...
export const UserActiveIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            fill="currentColor"
            className={classNames}
...
export const UserIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            className={classNames}
            width={width}
...
export const LiveActiveIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            fill="currentColor"
            className={classNames}
...
export const LiveIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            className={classNames}
            width={width}
...
export const ExploreActiveIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            fill="currentColor"
            className={classNames}
...
export const ExploreIcon = ({ classNames, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <svg
            fill="currentColor"
            className={classNames}
